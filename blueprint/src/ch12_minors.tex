...
\begin{proof}
  ...
  Therefore, as \((x_i)_{i\in\mathbb{N}}\) is infinite, we can construct an infinite subsequence \((x_{i_k})_{k\in\mathbb{N}}\) such that \(\forall k\in\mathbb{N}, x_{i_k}\not\leq\x_{i_{k+1}}\)
  
  This is an antichain which contradicts the well-quasi-ordered property.
