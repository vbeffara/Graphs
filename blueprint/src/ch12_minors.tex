...
\begin{lemma}[Diestel Lemma~12.3.4]
  \label{lem:td-bag-separation} \lean{TreeDecomposition.diestel_12_3_4_global} \leanok
  \uses{def:tree-decomposition,lem:td-edge-separator}
  Any set of vertices not contained in a bag of \((T,V)\) contains two
